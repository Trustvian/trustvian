...
> Retained for engineering history only. This is not the current roadmap or
> an instruction to implement anything — the `v0.1` work it describes shipped
> long ago. For current plans see [ROADMAP.md](../../ROADMAP.md); for what
