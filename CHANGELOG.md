...
- **`golang.org/x/crypto` upgraded to `v0.56.0`** in the processor module,
  clearing two advisories (`GO-2026-6355`, `GO-2026-6354`). A third
  (`GO-2026-5932`) has no upstream fix and is not reachable from Trustvian
  code; it is recorded as a documented exception with a review condition.
